...
class CameraReciver():
    def __init__(self):
        ...
        self.lane_momonet_pub = rospy.Publisher("right_lane_moment_x", Int32, queue_size= 3)
    ...
    def camera_callback(self, _data):
        if self.initialized == False:
            ...
            cv2.createTrackbar("low_V", "Simulator_Image", 66 , 255, nothing)
        ...
        cv_image = self.bridge.imgmsg_to_cv2(_data)
        ...
        crop_image = cv_image.copy()[390:480, 320:640, :]
        ...
        self.lane_momonet_pub.publish(Int32(self.x))
